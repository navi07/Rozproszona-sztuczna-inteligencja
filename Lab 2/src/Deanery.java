...
public class Deanery {
    ...
    protected String departmentName = "Wydział Inżynierii Metali i Informatyki Przemysłowej";
    protected char[] departmentShortcut = { 'W', 'I', 'M', 'i', 'I', 'P' };
    ...
    public void setStudentFinalGrade(int id, double finalGrade){
        students.get(id-1).setAverageGrade(finalGrade);
    }
}
