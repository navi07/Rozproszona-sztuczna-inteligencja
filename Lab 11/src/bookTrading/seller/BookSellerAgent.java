...
public class BookSellerAgent extends Agent {
  ...
  **/
  public void putForSale(String title, int numberOfPages, int initPrice, int minPrice, Date deadline) {
    addBehaviour(new PriceManager(this, title, numberOfPages, initPrice, minPrice, deadline));
  }
  ...
  private class PriceManager extends TickerBehaviour {
    ...
    private int minPrice, currentPrice, initPrice, deltaP, numberOfPages;
    private long initTime, deadline, deltaT;

    private PriceManager(Agent a, String t, int n, int ip, int mp, Date d) {
